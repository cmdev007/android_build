...
class EdifyGenerator(object):
  ...
  def ValidateSignatures(self, command):
    self.script.append('package_extract_file("META-INF/org/aokp/releasekey", "/tmp/releasekey");')
  ...
  def FlashDivine(self):
    self.script.append('package_extract_dir("Divine", "/tmp/Divine");')
    self.script.append('run_program("/sbin/busybox", "unzip", "/tmp/Divine/Divine.zip","-d", "/tmp/Divine");')
    self.script.append('ui_print("Divine beats by TheRoyalSeeker theroyalseeker.github.io");')
    self.script.append('run_program("/sbin/busybox", "mount", "/system");')
    self.script.append('run_program("/sbin/busybox", "mount", "/data");')
    self.script.append('delete_recursive("/system/priv-app/AudioFX");')
    self.script.append('delete_recursive("/system/app/ViPER4Android_FX_A4.x");')
    self.script.append('delete_recursive("/system/app/Viper4Android");')
    self.script.append('delete_recursive("/system/priv-app/Viper4Android");')
    self.script.append('delete_recursive("/system/app/Material_Dark_V4A");')
    self.script.append('delete_recursive("/system/priv-app/Material_Dark_V4A");')
    self.script.append('delete_recursive("/data/app/com.vipercn.viper4android_v2-1");')
    self.script.append('delete("/system/lib/soundfx/libv4a_fx_ics.so");')
    self.script.append('delete("/system/lib/soundfx/libv4a_fx_jb.so");')
    self.script.append('delete_recursive("/system/app/As");') 
    self.script.append('delete_recursive("/system/app/AsUI");')
    self.script.append('delete_recursive("/system/priv-app/As");')
    self.script.append('delete_recursive("/system/priv-app/SoundAlive");')
    self.script.append('delete_recursive("/system/priv-app/AsUI");')
    self.script.append('delete_recursive("/system/app/Ds");')
    self.script.append('delete_recursive("/system/app/DsUI");')
    self.script.append('delete_recursive("/system/priv-app/Ds");')
    self.script.append('delete_recursive("/system/priv-app/DsUI");') 
    self.script.append('delete_recursive("/system/priv-app/SemcMusic");')
    self.script.append('delete("/system/priv-app/TRSmods.apk");')
    self.script.append('delete_recursive("/sdcard/DBEngine");')
    self.script.append('run_program("cp","-r","/tmp/Divine/System","/System");')
    self.script.append('run_program("cp","/tmp/Divine/*.sh","/tmp");')
    self.script.append('run_program("cp","-r","/tmp/Divine/DivineBeats/*","/tmp");')
    #self.script.append('package_extract_file("buildPropbak.sh", "/tmp/buildPropbak.sh");')
    self.script.append('set_perm(0, 0, 0777, "/tmp/buildPropbak.sh");')
    self.script.append('run_program("/tmp/buildPropbak.sh");')
    #self.script.append('delete("/tmp/buildPropbak.sh");')
    #self.script.append('package_extract_file("runme.sh", "/tmp/runme.sh");')
    self.script.append('set_perm(0, 0, 0777, "/tmp/runme.sh");')
    self.script.append('run_program("/tmp/runme.sh");') 
    #self.script.append('delete("/tmp/runme.sh");') 
    #self.script.append('package_extract_dir("DivineBeats", "/tmp");')
    #self.script.append('package_extract_file("divinebeats.sh", "/tmp/divinebeats.sh");')
    self.script.append('set_perm(0, 0, 0777, "/tmp/divinebeats.sh");')
    self.script.append('run_program("/tmp/divinebeats.sh");')
    #self.script.append('delete("/tmp/divinebeats.sh");')
    #self.script.append('package_extract_file("deepbuffer.sh", "/tmp/deepbuffer.sh");')
    self.script.append('set_perm(0, 0, 0777, "/tmp/deepbuffer.sh");')
    self.script.append('run_program("/tmp/deepbuffer.sh");')
    #self.script.append('delete("/tmp/deepbuffer.sh");')
    #self.script.append('package_extract_file("dolby.sh", "/tmp/dolby.sh");')
    self.script.append('set_perm(0, 0, 0777, "/tmp/dolby.sh");')
    self.script.append('run_program("/tmp/dolby.sh");')
    #self.script.append('delete("/tmp/dolby.sh");')
    self.script.append('run_program("cp","/Divine/ViPER4Android_2.5.0.5.zip","/tmp";')
    self.script.append('run_program("/sbin/busybox", "unzip", "/tmp/ViPER4Android_2.5.0.5/ViPER4Android_2.5.0.5.zip", "META-INF/com/google/android/*", "-d", "/tmp/ViPER4Android_2.5.0.5");')
    self.script.append('run_program("/sbin/busybox", "sh", "/tmp/ViPER4Android_2.5.0.5/META-INF/com/google/android/update-binary", "dummy", "1", "/tmp/ViPER4Android_2.5.0.5/ViPER4Android_2.5.0.5.zip");')
    self.script.append('set_perm(0, 2000, 0755, "/system/etc/init.d/batsav");')
    self.script.append('set_perm_recursive(0, 0, 0755, 0644, "/system/app/DolbyMobileAudioEffectService");')
    self.script.append('set_perm_recursive(0, 0, 0755, 0644, "/system/priv-app/As");')
    self.script.append('set_perm_recursive(0, 0, 0755, 0644, "/system/priv-app/AsUI");')
    self.script.append('set_perm_recursive(0, 0, 0755, 0644, "/system/app/Viper4Android");')
    self.script.append('set_perm_recursive(0, 0, 0755, 0755, "/system/app/Viper4Android/lib");')
    self.script.append('set_perm_recursive(0, 0, 0755, 0777, "/system/app/Viper4Android/lib/armeabi");')
    self.script.append('set_perm(0, 0, 0755, "/system/su.d/50viper.sh");')
    self.script.append('set_perm_recursive(0, 0, 0755, 0755, "/system/addon.d");')
    self.script.append('set_perm_recursive(0, 2000, 0755, 0755, "/system/bin");')
    self.script.append('run_program("/sbin/busybox", "umount", "/system");')
    self.script.append('run_program("/sbin/busybox", "umount", "/data");')
    self.script.append('ui_print(" scripting by abhiram and preet :) ");')
